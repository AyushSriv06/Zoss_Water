...
import { adminAPI, productsAPI, servicesAPI, inventoryAPI, blogsAPI } from '@/lib/api';
...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      setLoading(true);
      const [statsRes, usersRes, productsRes, pendingRes, templatesRes, blogsRes] = await Promise.all([
